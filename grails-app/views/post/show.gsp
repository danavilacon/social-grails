			...
			<ol class="property-list post">
				...
				<li class="fieldcontain">
					<span id="blog-label" class="property-label"><g:message code="post.blog.label" default="Blog" /></span>
						...
						<span class="property-value" aria-labelledby="blog-label"><g:link controller="blog" action="show" id="${postInstance?.blog?.id}">${postInstance?.blog?.encodeAsHTML()}</g:link></span>
