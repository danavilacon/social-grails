...
<html>
	...
	<body>
		<a href="#list-userDepartment" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="list-userDepartment" class="content scaffold-list" role="main">
			...
			<div class="pagination">
				<g:paginate total="${userDepartmentInstanceCount ?: 0}" />
			</div>
		</div>
	</body>
</html>
